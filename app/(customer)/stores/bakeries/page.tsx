  ...
  return (
    <div className="min-h-screen bg-white pb-24">
      <div className="sticky top-0 z-30 bg-white border-b border-gray-100 px-4 py-3 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-base font-bold text-gray-900">Bakeries &amp; Sweets</h1>
          <p className="text-sm text-gray-500">
            {list.length} {list.length === 1 ? 'bakery' : 'bakeries'} near Ardhapur
          </p>
        </div>
      </div>
      ...
      {list.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 gap-3">
          ...
          <p className="text-sm text-gray-500">No bakeries listed yet</p>
            ...
            <Link key={merchant.id} href={`/stores/${merchant.id}`} className="block">
              <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
                {merchant.cover_image_url ? (
                  ...
                  <div className="aspect-video bg-gradient-to-br from-pink-300 to-orange-200 flex items-center justify-center">
