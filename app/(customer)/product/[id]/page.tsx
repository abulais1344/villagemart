...
import { ArrowLeft, Star, Store, Minus, Plus, ShoppingCart, Heart } from 'lucide-react';
...
export default function ProductDetailPage() {
  ...
  if (!product) return <div className="p-8 text-center text-[#6B7280]">Product not found</div>;
