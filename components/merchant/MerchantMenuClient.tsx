...
import { useMerchant } from '@/app/(merchant)/merchant/MerchantProvider';
...
export function MerchantMenuClient({ initialMenu }: Props) {
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    placeholder="0"
                    className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none follow:border-[#7C3AED]"
                  />
                </div>
              </div>
